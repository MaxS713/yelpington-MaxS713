...
// I needed this to use a local files for leaflet, I hope you were able to npm install it! 
...
and one that would display for the single restaurant page
  ...
  return (
    <div id="map-container">
      ...
      >
        ...
        {/* Again, thanks to the .map method, this renders a unique marker 
